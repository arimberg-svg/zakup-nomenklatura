...
NAMING_HINTS = {
    ...
    2: "Так выглядит корректное наименование в карточке 1С.",
}
SINGLE_HINTS = {
...
MASS_HINTS = {
    1: "Подготовьте список: наименование по формуле, штрихкод, при наличии — артикул.",
    2: "В 1С откройте раздел «Номенклатура».",
    3: "Встаньте в ту ветку справочника, куда нужно положить новые товары.",
    4: "Новую группу создавайте только если подходящей ещё нет.",
    5: "Имя группы — как вы реально ищете этот ассортимент в 1С.",
    6: f'Скачайте модуль: <a href="{MODULE_URL}" target="_blank" rel="noopener">{MODULE_URL}</a>',
    7: "В модуле настройте колонки под ваш файл.",
    8: "Загрузите в модуль наименование и штрихкод.",
    9: "Сопоставьте графы модуля с колонками списка один в один.",
    10: "Единица измерения — штуки, если нет отдельного указания.",
    11: "Когда все поля заполнены — кнопка «Загрузить».",
    12: "Проверьте протокол: сколько создано, нет ли ошибок и дублей.",
    13: "Если ошибок нет — закройте модуль и зайдите в группу, куда заливали товары.",
...
TITLES = {
    ...
    "mass": {
        ...
        6: "Скачать модуль массовой заливки",
  ...
  <main class="wrap">
    ...
    <details class="topic" id="mass">
      ...
      <div class="topic-body">
        ...
        <div class="note">
          <b>Модуль массовой заливки</b>
          Скачать: <a href="{MODULE_URL}" target="_blank" rel="noopener">{MODULE_URL}</a><br>
          После загрузки обязательно проставьте бренд всем новым позициям — модуль сам это не делает.
        </div>
        {mass}
        <div class="warn">
          <b>После заливки проверьте 2–3 карточки</b>
          Наименование, штрихкод, единица, бренд, правильная группа.
        </div>
      </div>
    </details>
